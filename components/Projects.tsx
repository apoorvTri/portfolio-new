...
const projectsData: Project[] = [
  ...
  {
    id: "speech-to-text",
    title: "Real-Time AI Speech Workspace (Speech-To-Text Platform)",
    description: "A real-time speech-to-text engine with live streaming subtitles and full offline transcription. Employs a WebSocket audio pipeline with FFmpeg PCM decoding and rolling buffers for sub-second streaming, plus custom caption-stabilization logic for duplicate phrase suppression.",
    tech: ["FastAPI", "Faster-Whisper", "WebSockets", "JavaScript", "FFmpeg"],
  ...
  {
    id: "geoplugin",
    title: "GeoPlugin – Location Intelligence Platform",
    description: "A full-stack geolocation platform supporting forward/reverse geocoding and real-time mapping. Features a modular FastAPI backend integrating OpenStreetMap APIs to handle spatial queries asynchronously and an interactive React frontend with dynamic map layers.",
    tech: ["React", "FastAPI", "Leaflet", "Tailwind", "Python"],
    githubUrl: "https://github.com/apoorvTri/geo-plugin",
    featured: true,
    category: "fullstack",
  },
  {
